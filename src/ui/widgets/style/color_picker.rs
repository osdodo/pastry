...
mod tests {
    ...
    fn primary_theme_active() {
        ...
        let expected_border_radius = if cfg!(target_os = "windows") {
            0.0
        } else {
            15.0
        };
        let expected_bar_border_radius = if cfg!(target_os = "windows") {
            0.0
        } else {
            5.0
        };
        ...
        assert_eq!(style.border_radius, expected_border_radius);
        assert_eq!(style.border_width, 1.0);
        assert_eq!(style.bar_border_radius, expected_bar_border_radius);
